...
# Make sure SUDO_USERS is imported if you use it in other filters
...
f_onw_filter = filters.create(func=onw_filter, name="OnwFilter")


# 👇 YAHI WO FILTER HAI JISKI WAJAH SE CRASH HO RAHA THA 👇
