...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/istkharroohi78/Roohi",
)
...
GITHUB = getenv("GITHUB", "https://t.me/ony4you")
...
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/f09yfp.jpg").split()
